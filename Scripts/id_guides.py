...
def merge_spacer_files(txt_file_path, csv_file_path, output_file_path, ct_file):
    ...
    # Make clumn combining spacer1 & spacer2 for merging
    df_txt['spacer1_spacer2'] = df_txt['SPACER1'] + df_txt['SPACER2']

    # Merge with the CSV file on the matching column
    df_merged = df_txt.merge(df_csv[["Seq1-Seq2_rc", "Guide1_Guide2_Name"]], 
    ...
    df_counts = df_dedup.groupby(['cell', 'Guide1_Guide2_Name'])['umi'].count().reset_index()
