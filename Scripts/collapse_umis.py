...
group_cols = ['cell', 'SPACER1', 'SPACER2']
for group_key, group_df in df.groupby(group_cols):
    umis = group_df['umi'].tolist()
    ...
    group_df['collapsed_umi'] = group_df['umi'].map(collapse_map)
...
umi_df = umi_df.rename(columns={'collapsed_umi': 'umi'})
